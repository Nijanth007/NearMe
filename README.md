...
<html>
    <body>
        <head>
            ...
            <img src="Ariyalur map.png" alt="Sample image" usemap="#image-map">
        <map name="image-map"
    <center>
...
<html>
    ...
    <center>
        <h2>  Beauty of Ariyalur  </h2>
    </center></title>    
    <center>
        <h1>GANGAI KONDA CHOLAPURAM</h1>    
    </center>
   
    <center>
        <img src="gangaikonda-cholapuram.jpg"  width="65% " height="50%">
...
<html>
    ...
    <center>
        <img src="museum.jpeg"  width="30% " height="20%">
...
<html>
    ...
    <center>
        <h1>CEMENT FACTORY</h1>    
    </center>
   
    <center>
        <img src="cement.jpeg"  width="65% " height="50%">
...
<html>
    ...
    <center>
        <img src="kovil.jpeg"  width="25% " height="35%">
...
<html>
    ...
    <center>
        <h1>MEDICAL COLLEGE ARIYALUR </h1>    
    </center>
   
    <center>
        <img src="college.webp"  width="60% " height="40%">
